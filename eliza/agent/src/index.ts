...
import { aethermintCharacter } from "./aethermintCharacter.ts";
...
import mintNftPlugin from "./plugin-nft/index.ts";
...
export async function loadCharacters(
    ...
    if (loadedCharacters.length === 0) {
        elizaLogger.info("No characters found, using Aethermint character");
        loadedCharacters.push(aethermintCharacter);
    }
...
const startAgents = async () => {
    ...
    let characters = [aethermintCharacter];
